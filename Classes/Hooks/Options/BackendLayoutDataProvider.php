<?php
namespace Qbus\Qbbootstrap\Hooks\Options;
...
class BackendLayoutDataProvider implements \TYPO3\CMS\Backend\View\BackendLayout\DataProviderInterface {
	...
	public function addBackendLayouts(DataProviderContext $dataProviderContext, BackendLayoutCollection $backendLayoutCollection)
	{
		...
		if (isset($pageTSconfig['tx_qbbootstrap.']['backend_layout.'])) {
			foreach ($pageTSconfig['tx_qbbootstrap.']['backend_layout.'] as $id => $layout) {
	...
	public function getBackendLayout($identifier, $pageId)
	{
		...
		if (isset($pageTSconfig['tx_qbbootstrap.']['backend_layout.'][$identifier . '.'])) {
			return $this->createBackendLayout($identifier, $pageTSconfig['tx_qbbootstrap.']['backend_layout.'][$identifier . '.']);
		}
